# Marlin 3D Printer Firmware, with correct configuration for BCN3D+ printers
...
## Usage on a BCN3D+ printer

The only changed file is Configuration.h. The correct bed size and steps per mm are set.
Additional features enabled are :

- Manual bed levelling
- Corner bed levelling
- SD card
- LCD screen
